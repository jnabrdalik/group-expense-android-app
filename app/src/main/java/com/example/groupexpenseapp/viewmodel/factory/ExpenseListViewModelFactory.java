...
public class ExpenseListViewModelFactory extends ViewModelProvider.NewInstanceFactory {

    @NonNull
    private final Application application;
    private final long groupId;

    public ExpenseListViewModelFactory(@NonNull Application application, long groupId) {
